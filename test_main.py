...
class TestMain:
    ...
    async def test_main_missing_api_key(self):
        with patch('main.create_ai_provider', side_effect=ValueError("API key missing")):
    ...
    async def test_main_text_input_success(self):
        ...
        with patch('main.create_ai_provider', return_value=mock_ai_provider):
            with patch('main.create_mcp_client', new_callable=AsyncMock, return_value=mock_mcp_client):
    ...
    async def test_main_voice_input_selected(self):
        ...
        with patch('main.create_ai_provider', return_value=mock_ai_provider):
            with patch('main.get_voice_input', new_callable=AsyncMock, return_value=None):
    ...
    async def test_main_parse_request_failure(self):
        ...
        with patch('main.create_ai_provider', return_value=mock_ai_provider):
            with patch('main.create_amap_client', return_value=mock_amap_client):
